...
class EnhancedDocumentProcessor:
    """Enhanced document processor with OCR capabilities for PDFs"""
    ...
    def extract_text_from_pdf(self, pdf_path: str) -> str:
        ...
        return f"Failed to extract text from {os.path.basename(pdf_path)}. The file may be corrupted or contain only images without readable text."
    
    def process_documents(self, directory: str) -> List[Tuple[str, Dict]]:
        """Process all documents in directory with OCR support"""
        documents = []
...
def initialize_enhanced_ai_system():
    """Enhanced AI system initialization with OCR support"""
    try:
        ...
        # Process all documents including PDFs with OCR
...
<div class="main-header">
    ...
    <h3>Data Science & Analytics Expert with OCR Support</h3>
    <p>Ask me anything about Rory's experience, skills, projects, or insights! Now with PDF OCR capabilities.</p>
</div>
""", unsafe_allow_html=True)

# Initialize enhanced AI system with OCR
with st.spinner("🚀 Initializing Enhanced AI system with OCR support..."):
...
<div class="status-info">
    ...
    {total_chunks} knowledge chunks available | 🔍 OCR-Enabled PDF Processing | 🎯 Advanced Analysis & Human-Level Reasoning</span>
</div>
""", unsafe_allow_html=True)
...
with col2:
    ...
    if "messages" not in st.session_state:
        ...
        st.session_state.messages.append({
            "role": "assistant", 
            "content": "👋 Hello! I'm Rory's AI assistant with enhanced OCR capabilities. I can now process PDF documents and extract information from them. Feel free to ask me anything about Rory's background, projects, or expertise. You can also click on the sample questions above for quick answers!"
        })
...
<div style="text-align: center; padding: 2rem; color: #666;">
    <p>🤖 <strong>Rory's AI Assistant</strong> | Powered by Advanced AI & Machine Learning | 🔍 OCR-Enabled PDF Processing</p>
    <p>📧 For direct contact or collaboration opportunities, please ask the AI for Rory's contact information</p>
    <p><em>This AI assistant is trained on Rory's professional experience and knowledge base with OCR support for PDF documents</em></p>
</div>
""", unsafe_allow_html=True)
